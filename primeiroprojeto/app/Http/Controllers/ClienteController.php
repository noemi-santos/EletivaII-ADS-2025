...
class ClienteController extends Controller
{
    ...
    public function update(Request $request, string $id)
    {
        try{
            ...
            return redirect()->route("clientes.index")->with("sucesso", "Registro alterado!");
            ...
            return redirect()->route("clientes.index")->with("erro", "Erro ao alterar!");
    ...
    public function destroy(string $id)
    {
        try{
            $cliente = Cliente::findOrFail($id);
            $cliente->delete();
            return redirect()->route("clientes.index")->with("sucesso", "Registro excluido!");
            ...
            return redirect()->route("clientes.index")->with("erro", "Erro ao excluir!");
